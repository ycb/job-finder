                ...
                {pagedJobs.length === 0 ? (
                  jobsAllInSelectedView.length > 0 ? (
                    ...
                    <div className="rounded-lg border border-dashed border-border bg-secondary/20 p-4 text-sm text-muted-foreground">
                      <span className="font-medium text-foreground">Queue complete.</span>{" "}
                      All {queueBreakdown.stored} stored jobs are triaged — see the view
                      selector above. New matches arrive with your next search run.
                    </div>
                  ) : (
                    <div className="rounded-lg border border-dashed border-border bg-secondary/20 p-4 text-sm text-muted-foreground">
