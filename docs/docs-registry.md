...
| `docs/roadmap/yc-jobs-http-direct-notes.md` | Contributors/operators | Reusable YC Jobs source-type notes covering auth-required product integration, canonical review targets, and verification pattern | YC Jobs product-integration or source-type contract changes |
| `docs/roadmap/levelsfyi-http-direct-notes.md` | Contributors/operators | Reusable Levels.fyi source-type notes covering no-auth direct HTTP behavior, canonical review targets, salary-rich extraction, and verification pattern | Levels.fyi product-integration or source-type contract changes |
